 ...
 * Router
 *
 * $Id: Router.php 3769 2008-12-15 00:48:56Z zombor $
 *
 * @package    Core
 * @author     Kohana Team
...
class Router {
	...
	public static function setup()
	{
		...
		{
			// Load routes
			self::$routes = DEFAULT_CONTROLLER;
		}
		...
		if (self::$current_uri === '')
		{
			...
			self::$current_uri = DEFAULT_CONTROLLER;
	...
	public static function find_uri()
	{
		...
		if (self::$current_uri !== '')
		{
			if ($suffix = URL_SUFFIX AND strpos(self::$current_uri, $suffix) !== FALSE)
			{
