    ...
    <div id="sidebar">
      ...
      <?php /* Frontpage */ if (is_home() || (is_page() && get_option('unnamed_showsidebarpage') == 1) || (is_archive() && get_option('unnamed_showsidebarcat') == 1) || is_single() || ((function_exists('is_tag') && is_tag()) && get_option('unnamed_showsidebarcat') == 1) ) { ?>
      ...
      <div class="right-sidecolumn">
        ...
        <li id="meta" class="widget-container">
					...
					main_sub="c1s17d";
					more_subs="zhuaxia_01,google_01,xianguo_01,qq_01";
					is_new="no";
					--> </script>
					<script language="javascript" src="http://www.feedsky.com/jsout/publishlist_v2.js?burl=gqmk&out_html=true"></script>
					<!-- Feedsky FEED发布代码结束 -->
				</li>
