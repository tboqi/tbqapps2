...
{
var fck = new FCKeditor('summary');
fck.Width = 680;
fck.Height = 300;
fck.BasePath = "<?php echo Kohana::config('core.static_website'); ?>js/fck/";
fck.ReplaceTextarea() ;
...
<table>
    ...
    <tr>
        <td>摘要</td>
        <td><textarea name="summary" id="summary"><?php echo isset($article) ? $article->summary : ''; ?></textarea></td>
    </tr>
    <tr>
        <td>内容</td>
