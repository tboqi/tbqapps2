          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a target="_blank" href="<?php echo URL::site_common('product/detail/' . $product->id);?>" title="<?php echo $product->title;?>"><?php echo $product->title;?></a></td>
                <td>
                  <!-- Icons -->
                  <?php /*<a href="#" title="Edit"><img src="<?php echo Resource::image("icons/pencil.png"); ?>" alt="Edit" /></a>*/?>
                  <a href="<?php echo url::site('product/del/' . $product->id)?>" title="Delete" class="del"><img src="<?php echo Resource::image("icons/cross.png"); ?>" alt="Delete" /></a>
