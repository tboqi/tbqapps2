...
<div id="footer">
    <div id="footer-wrapper">
        ...
        <div class="grid col-300 fit powered">
            <p><a href="<?php echo esc_url(__('http://wordpress.org/','shell'));?>" title="<?php esc_attr_e('WordPress', 'shell'); ?>" rel="generator"><?php
printf(__('Powered by %s', 'shell'), 'WordPress');?></a> <a href="<?php echo esc_url(__('http://themeid.com/','shell'));?>" title="<?php esc_attr_e('ThemeID', 'shell'); ?>" rel="designer"><?php
printf(__('&amp; %s', 'shell'), 'ThemeID');?></a></p>
        </div><!-- end .powered -->
