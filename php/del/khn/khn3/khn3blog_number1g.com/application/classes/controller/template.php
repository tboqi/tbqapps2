...
abstract class Controller_Template extends Controller {
	...
	public function before() {
		...
		$this->title = Kohana::$config->load('site.web_title');
	}
	...
	function after() {
		...
		$this->template->keywords = empty($this->keywords) ? Kohana::$config->load('site.keywords') : $this->keywords;
		$this->template->description = empty($this->description) ? Kohana::$config->load('site.description') : $this->description;
