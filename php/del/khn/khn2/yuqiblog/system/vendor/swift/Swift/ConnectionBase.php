...
abstract class Swift_ConnectionBase implements Swift_Connection {
	...
	public function getAttributes($extension) {
		if ($this->hasExtension ( $extension )) {
			...
			throw new Swift_ConnectionException ( "Unable to locate any attributes for the extension '" . $extension . "' since the extension cannot be found. " . "Consider using hasExtension() to check." );
		}
	}
	/**
