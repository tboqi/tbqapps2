 ...
 *
 * $Id: Database.php 4037 2009-03-04 23:35:53Z jheathco $
 *
 * @package    Core
 * @author     Kohana Team
...
class Database_Core {
	...
	// Configuration
	protected $config = array ('benchmark' => TRUE, 'persistent' => FALSE, 'connection' => '', 'character_set' => 'utf8', 'table_prefix' => '', 'object' => TRUE, 'cache' => FALSE, 'escape' => TRUE );
		...
		if (func_num_args () > 1) //if we have more than one argument ($sql)
{
	...
	public function push() {
		array_push ( $this->query_history, array ($this->select, $this->from, $this->join, $this->where, $this->orderby, $this->order, $this->groupby, $this->having, $this->distinct, $this->limit, $this->offset ) );
	...
	public function pop() {
		...
		list ( $this->select, $this->from, $this->join, $this->where, $this->orderby, $this->order, $this->groupby, $this->having, $this->distinct, $this->limit, $this->offset ) = array_pop ( $this->query_history );
