 ...
 * HTML helper class.
 *
 * $Id: html.php 4021 2009-02-26 21:38:10Z jheathco $
 *
 * @package    Core
 * @author     Kohana Team
...
class html_Core {
	...
	public static function anchor($uri, $title = NULL, $attributes = NULL, $protocol = NULL) {
		...
		return // Parsed URL
		'<a href="' . html::specialchars ( $site_url, FALSE ) . '"' . // Attributes empty? Use an empty string
	...
	public static function file_anchor($file, $title = NULL, $attributes = NULL, $protocol = NULL) {
		...
		'<a href="' . html::specialchars ( url::base ( FALSE, $protocol ) . $file, FALSE ) . '"' . // Attributes empty? Use an empty string
