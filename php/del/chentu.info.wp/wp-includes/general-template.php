...
function wp_head() {
	...
	echo "<!-- FEED自动发现标记开始 -->
<link title=\"RSS 2.0\" type=\"application/rss+xml\" href=\"http://feed.feedsky.com/gqmk\" rel=\"alternate\" />
<!-- FEED自动发现标记结束 -->
<script type=\"text/javascript\">

  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-16790085-1']);
  _gaq.push(['_setDomainName', '.chentu.info']);
...
document.write(unescape("%3Cscript src=\'" + _bdhmProtocol + "hm.baidu.com/h.js%3F25e8c2c100c8462a8b9bae6286e51f52\' type=\'text/javascript\'%3E%3C/script%3E"));
</script>';
}
