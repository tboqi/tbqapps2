...
<head>
<?php echo new View('admin/authenticate'); ?>
<meta http-equiv="content-type" content="text/xml; charset=utf-8" />
<title>后台管理菜单</title>
<script type="text/javascript">
      /* declare the URL to navbar */
      _NavBar_url = "<?php echo url::base (); ?>navbar/";
      _NavBar_icons_url = "<?php echo url::base (); ?>navbar/themes/winxp/";
    </script>
<!-- include the main script -->
<script type="text/javascript" src="<?php echo url::base (); ?>navbar/navbar.jss"></script>
      ...
      function initDocument() {
        ...
        section = new NavSection(menu, "<?php echo $menu->name; ?>",
                       ...
                       [ "<?php echo $submenu->name; ?>", 
                         ...
                         echo url::site_index($submenu->uri); 
                         } else {
