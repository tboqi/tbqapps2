 ...
 * Validation library.
 *
 * $Id: Validation.php 3897 2009-01-12 22:13:03Z jheathco $
 *
 * @package    Validation
 * @author     Kohana Team
...
class Validation_Core extends ArrayObject {
	...
	public function field_names() {
		...
		$fields = array_unique ( array_merge ( array_keys ( $this->pre_filters ), array_keys ( $this->rules ), array_keys ( $this->callbacks ), array_keys ( $this->post_filters ) ) );
