 ...
 *
 * $Id: Memcache.php 4061 2009-03-06 17:58:12Z Shadowhand $
 *
 * @package    Cache
 * @author     Kohana Team
...
class Cache_Memcache_Driver implements Cache_Driver {
	...
	public function __construct() {
		...
		foreach ( $servers as $server ) {
			...
			$this->backend->addServer ( $server ['host'], $server ['port'], ( bool ) $server ['persistent'] ) or Kohana::log ( 'error', 'Cache: Connection failed: ' . $server ['host'] );
		}
