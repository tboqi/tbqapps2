 ...
 * Form helper class.
 *
 * $Id: form.php 3990 2009-02-16 00:17:21Z jheathco $
 *
 * @package    Core
 * @author     Kohana Team
...
class form_Core {
	...
	public static function attributes($attr, $type = NULL) {
		...
		$order = array ('action', 'method', 'type', 'id', 'name', 'value', 'src', 'size', 'maxlength', 'rows', 'cols', 'accept', 'tabindex', 'accesskey', 'align', 'alt', 'title', 'class', 'style', 'selected', 'checked', 'readonly', 'disabled' );
