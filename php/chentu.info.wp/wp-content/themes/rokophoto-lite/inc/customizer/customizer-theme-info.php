...
function rokophotolite_theme_info_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'rokophotolite_theme_info', array(
			'title'    => __( 'Theme info', 'rokophotolite' ),
			'priority' => 0,
		)
	);
	$wp_customize->add_setting( 'rokophotolite_theme_info', array(
			'capability'        => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		)
	);
	$wp_customize->add_control( new RokoPhoto_Info( $wp_customize, 'rokophotolite_theme_info', array(
