...
function rokophoto_scripts() {
	...
	wp_enqueue_style( 'rokophoto_style', get_stylesheet_uri() );
	...
	if ( isset( $rokophoto_disable_animation ) && $rokophoto_disable_animation != 1 ) { wp_enqueue_script( 'rokophoto_wow', get_template_directory_uri() . '/js/wow.min.js',array( 'jquery' ),'',true );
	}
