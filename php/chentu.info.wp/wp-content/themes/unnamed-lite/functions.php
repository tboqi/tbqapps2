...
function unnamed_fontcolor() {
    ...
    if (get_option('unnamed_fontcolor') == '') {
        return '#333333';
    }
...
function unnamed_linkcolor() {
    ...
    if (get_option('unnamed_linkcolor') == '') {
        return '#5D8BB3';
    }
...
function unnamed_hovercolor() {
    ...
    if (get_option('unnamed_hovercolor') == '') {
        return '#3465A4';
    }
...
function unnamed_contentcolor() {
    ...
    if (get_option('unnamed_contentcolor') == '') {
        return '#FFFFFF';
    }
...
function unnamed_bgimage() {
    ...
    if (get_option('unnamed_bg_image') == '') {
        return '';
    }
...
class UnnamedOptions {
    ...
    function unnamed_init() {
        ...
        if (function_exists('register_sidebar')) {
            register_sidebars(3, array('before_widget' => '<li id="%1$s" class="widget %2$s">',
