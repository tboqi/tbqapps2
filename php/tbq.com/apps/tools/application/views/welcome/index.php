...
<head>
    <title>工具箱</title>
    <link rel="shortcut icon" href="http://tbq_static.com/tools/favicon.ico" />
...
<div id="topmenu" class="l-topmenu">
    <div class="l-topmenu-logo">工具箱</div>
    ...
    <!--
        ...
        <a target="_blank" href="http://qiyezhan.cn" class="l-link2">企业站</a>
        <a target="_blank" href="http://tbq_static.com/ligerui/index.htm" class="l-link2">ligerUI</a>
        <span class="space">|</span>
        <a target="_blank" href="http://kohanaframework.org/" class="l-link2">kohana官网</a>
        <span class="space">|</span>
        <span class="space">|</span>
        <a href="<?=URL::site('user/edit_password')?>" class="l-link2" target="_blank">修改密码</a>
        <span class="space">|</span>
  ...
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; ">
        <div position="left"  title="主要菜单" id="accordion1">
            ...
            <div title="外部工具">
                ...
                <a class="l-link" href="http://www.bejson.com/" target="_blank">bejson</a>
                <a class="l-link" href="https://1024tools.com/unserialize" target="_blank">php在线反序列化</a>
                <a class="l-link" href="http://www.faviconico.org/favicon" target="_blank">favicon.ico在线制作</a>
            </div>
            <div title="应用场景">
                <div style="height:7px;"></div>
        ...
        <div position="center" id="framecenter">
            <div tabid="home" title="我的主页" style="height:300px" >
                <iframe frameborder="0" name="home" id="home" src="<?=URL::site('welcome/main')?>"></iframe>
            </div>
        </div>
