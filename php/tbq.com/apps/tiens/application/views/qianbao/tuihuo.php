...
<body style="padding:10px">
    ...
    <table>
		...
		<tr>
            ...
            <td><input name="head[transtype]" class="ui-textbox" type="text" size="30" value="4006" /></td>
		</tr>
		<tr>
    ...
    <table>
		...
		<tr>
			<td><label>交易流水：</label></td>
			<td><input type="text" size="30" name="body[systraceno]" class="ui-textbox" /></td>
		</tr>
		<tr>
