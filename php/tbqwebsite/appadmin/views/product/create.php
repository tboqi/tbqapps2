            ...
            <p>
              ...
              <select name="category_id" id="category_id" class="small-input">
                <option value="0">未分类</option>
								...
								<option value="<?php echo $category->id;?>"<?php if (isset($product) && $category->id == $product->category_id) {
    echo ' selected';
}
...
?>
            ...
            <p>
              <label>描述</label>
              <textarea class="text-input textarea" id="content" name="content" cols="79" rows="15"></textarea>
            </p>
            <p>
