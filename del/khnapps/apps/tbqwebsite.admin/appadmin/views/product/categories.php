<div class="content-box">
      ...
      <div class="content-box-content">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <!-- Icons -->
                  <a href="<?php echo url::site('product_category/edit/' . $category->id )?>" title="Edit" class="edit"><img src="<?php echo Resource::image("icons/pencil.png"); ?>" alt="Edit" /></a> 
                  <a href="<?php echo url::site('product_category/del/' . $category->id )?>" title="Delete"><img src="<?php echo Resource::image("icons/cross.png"); ?>" alt="Delete" /></a></td>
              </tr>
              <?php } ?>
            </tbody>
          </table>
        ...
        <div class="tab-content" id="tab2">
          <form id="categoryForm" action="<?php echo url::site('product_category/save'); ?>" method="post">
            <fieldset>
