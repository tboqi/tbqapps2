<!-- a href="<?php echo URL::site('admin/auth')?>">设置权限</a> -->
...
<head>
    ...
    <script src="/static/js/lib/jquery/jquery-1.9.0.min.js" type="text/javascript"></script>    
    <script src="/static/js/lib/ligerUI/js/ligerui.all.js" type="text/javascript"></script> 
    <script src="/static/js/lib/ligerUI/js/plugins/ligerTab.js"></script>
    <script src="/static/js/lib/jquery.cookie.js"></script>
    <script src="/static/js/lib/json2.js"></script>
    <script src="<?php echo URL::site('admin/welcome/menujs')?>" type="text/javascript"></script>
