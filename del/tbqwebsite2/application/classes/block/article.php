...
class Block_Article {
	...
	static function categories() {
		$view = Helper_View::create_view('blocks/article/categories');
		$model_article_category = new Model_Article_Category();
		$view->categories = $model_article_category->find_all('id,name');
		echo $view->render();
	}
	
	static function hot_articles() {
		$view = Helper_View::create_view('blocks/article/hotArticles');
	...
	static function article($article, $showContent = false) {
		$view = Helper_View::create_view('blocks/article/article');
