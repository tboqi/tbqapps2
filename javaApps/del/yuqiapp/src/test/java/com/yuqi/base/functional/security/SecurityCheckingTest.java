package com.yuqi.base.functional.security;

import org.junit.Test;
import com.yuqi.base.functional.BaseSeleniumTestCase;
...
public class SecurityCheckingTest extends BaseSeleniumTestCase {
	...
	public void checkAnonymous() {
		//访问退出登录页面,退出之前的登录
		selenium.open("/yuqiapp/j_spring_security_logout");
		assertTrue(selenium.isElementPresent("//input[@value='登录']"));

		//访问任意页面会跳转到登录界面
		selenium.open("/yuqiapp/security/user.action");
		assertTrue(selenium.isElementPresent("//input[@value='登录']"));
	}
