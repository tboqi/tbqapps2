...
<!--本周焦点 开始-->
<h3 class="bzjd">最新文章<a href="${base}/weeklist.action" title="点击查看更多"><img src="images/btn_more.png" /></a></h3>
<ul class="textlist">
...
<!--sideContent start-->
<div id="sideContent">
<h1 class="newchapterlist">本周看点<a href="${base}/rss/rssServlet/?feedType=newArticle"><img src="images/icon_rss.gif" alt="rss" title="rss" /></a></h1>
...
<#if articleMapList?exists>
	<#list articleMapList as map>
		<#if map?exists>
            ...
            <dd class="info_color"><#if map.member?exists><span class="scz_color">上传者：</span><a class="info_color" href="${base}/user/viewuser?memberId=#{map.member.id}" title="查看作者信息" alt="查看作者信息">${map.member.userName}&nbsp;&nbsp;</a>  <span class="ps_color">票数：#{map.rate!""}</span></#if>  <#if map.label?exists && map.label.size() &gt; 0 ><span class="scz_color">&nbsp;&nbsp;标签：</span><#list map.label as label><a class="info_color" href="${base}/search/search.action?qs=${stack.findValue("@com.cc.cw.util.URLCoderUtil@encode('${label}','UTF-8')")}&search=label&pn=1">${label}</a>&nbsp;&nbsp;<#if label_index=2><#break></#if></#list></#if>
