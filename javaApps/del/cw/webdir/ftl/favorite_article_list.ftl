...
<#if newArticle?exists>
    <p class="madecenter"><img class="right_pic_first" alt="${newArticle.title}" title="${newArticle.title}" src="${newArticle.imgSrc}" height="176" width="300"/></p>
...
<!--sideContent start-->
<div id="sideContent">
<h1 class="newchapterlist">推荐文章<#if 1=2><a href="${base}/rss/rssServlet/?feedType=newArticle"><img src="images/icon_rss.gif" alt="rss" title="rss" /></a></#if></h1>
		...
		<#if map?exists>
            ...
            <dd id="collDD_${map_index}" style="display: none" >
                <form action="${base}/addtochannel!reference.action" method="post" onsubmit="return checkCollForm(${map_index});">
                    ...
                    <input type="hidden" name="toPage" value="favoritelist" />
            ...
            <dd id="startDD_${map_index}" style="display: none" >
                <form action="${base}/addtochannel!add.action" method="post" onsubmit="return checkStartForm(${map_index});">
                    <input type="hidden" name="articleId" value="#{map.articleId}" />
                    <input type="hidden" name="toPage" value="favoritelist" />
                    <input type="hidden" id="cost_${map_index}" value="#{map.rate}" />
                     <#if myChannelList?exists>
