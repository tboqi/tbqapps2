...
<!--sideContent start-->
<div id="sideContent">
<h1 class="newchapterlist">最新文章<a href="${base}/rss/rssServlet/?feedType=newArticle"><img src="images/icon_rss.gif" alt="rss" title="rss" /></a></h1>
