...
<!--sideContent start-->
<div id="sideContent">
<h1 class="newchapterlist">支持到底<a href="${base}/rss/rssServlet/?feedType=newArticle"><img src="images/icon_rss.gif" alt="rss" title="rss" /></a></h1>
		...
		<#if map?exists>
            ...
            <dd id="collDD_${map_index}" style="display: none" >
                <form action="${base}/addtochannel!reference.action" method="post" onsubmit="return checkCollForm(${map_index});">
                    ...
                    <input type="hidden" name="toPage" value="supportlist" />
