...
<form name="form1" method="post" action="/cc/broadcast.action">
		<table border="1" cellspacing="0" cellpadding="0">
    		...
    		<tr>
    				<td width="67">标题</td>
    				<td width="174"><input name="articleTitle" type="text" id="articleTitle" value="${articleTitle?if_exists}"></td>
 				</tr><tr>
    				<td>内容</td>
