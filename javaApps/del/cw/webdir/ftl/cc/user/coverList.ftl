...
<table width="400" border="0" cellspacing="0" cellpadding="0">
		<tr>
				<td>
					<a href="/cc/member.action?flag=coverList">按注册时间排序</a>&nbsp;
					<a href="/cc/member.action?flag=coverListOrderByArticleCount">按发布文章多少排序</a>&nbsp;
				</td>
		</tr>
</table>
<#if list?exists>
<table border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
				<td><td colspan="4"><div align="center">${mpage.url} ${mpage.cp}/${mpage.pageCount} 每页${mpage.rowPerPage}条</div></td></td>
		</tr>
</table>
</#if>
</body>
