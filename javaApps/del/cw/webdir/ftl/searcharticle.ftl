...
<#if rs?exists && rs.size() &gt; 0>
		<#list rs as map>
            <dl>
                ...
                <dd class="list_show_content">${map.article.content}.....</dd>
            </dl>
    	</#list>
    <#else>
    <br><br><br><br>
